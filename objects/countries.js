var countries=[
  ...
  for(let country of countries){
      ...
      // console.log(`country name: ${countryName} capital: ${capital}  population: ${population}  currency: ${currencyName}`);
      let cntryData={
        countryName,capital,population,currencyName
      }
        myCountries.push(cntryData)
      
  }
  // myCountries.forEach(data=>console.log(data.countryName));
  // var india=myCountries.find(data=>data.countryName=="India")
  // console.log(india);
  

  //china currencyname
  // var china=myCountries.find(data=>data.countryName=="China").currencyName
  // console.log(china);


  //countrynames which have population above 2crore
  var hpop=myCountries.filter(pop=>pop.population>20000000).map(data=>data.countryName)
  console.log(hpop);